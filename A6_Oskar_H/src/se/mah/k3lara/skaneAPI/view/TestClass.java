...
public class TestClass {
	...
	public static void main(String[] args) {
		// hämtar metoden Constants.getURL med inparametrar startStationNumber, endStationNumber och nbrReslults
		...
		//hämtar metoden Parser.getJourneys som skriver ut en arraylist med sökresultat
		...
		//skapar en arraylist med stationer
